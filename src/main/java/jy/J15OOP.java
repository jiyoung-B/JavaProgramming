...
public class J15OOP {
    ...
    public static void main(String[] args) {
        ...
        Member m = new Member("jy", "010", "1234", "5678",
                "abc123", "xyz987.com");
...
class MemberService {
    ...
    public boolean newMember(Member mvo){
        System.out.println("회원정보 생성"+mvo);
        return false;
    }
    // 회원 조회R : read~
    ...
    public Member readOneMember(String name){
        System.out.println("회원정보 상세 조회"+name);
        return null;
    }
    // 회원수정U : modify~
    public boolean modifyMember(String name){
        System.out.println("회원정보 수정"+name);
        return false;
    }
    // 회원삭제D : remove~
    public boolean removeMember(String name){
        System.out.println("회원정보 삭제"+name);
        return false;
    }
}
